...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./masterlist.php">List of Teacher</a>
                </li>
            </ul>
        ...
        <div class="student-container">
            <div class="student-list">
                <div class="title">
                    ...
                    <button class="btn btn-dark" data-toggle="modal" data-target="#addStudentModal">Add Teacher</button>
                </div>
                <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./endpoint/add-student.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="studentCourse">Subject</label>
    ...
    <div class="modal fade" id="updateStudentModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="updateStudent" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateStudent">Update Teacher</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
