...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['student_name'], $_POST['course_section'])) {
        ...
        try {
            ...
            header("Location: http://localhost/Sarna-Project/QR-Teacher-Attendance/admin/teacher-attendance/masterlist.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/Sarna-Project/QR-Teacher-Attendance/admin/teacher-attendance/masterlist.php';
            </script>
        ";
    }
}
