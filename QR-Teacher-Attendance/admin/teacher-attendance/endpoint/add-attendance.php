...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['qr_code'])) {
        ...
        try {
            ...
            header("Location: http://localhost/Sarna-Project/QR-Teacher-Attendance/admin/teacher-attendance/index.php");
        ...
        echo "
            <script>
                ...
                window.location.href = 'http://localhost/Sarna-Project/QR-Teacher-Attendance/admin/teacher-attendance/index.php';
            </script>
        ";
    }
}
