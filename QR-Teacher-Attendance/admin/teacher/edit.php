 <?php
    ...
    if (isset($_POST["update"])) {
        ...
        $query = $conn->prepare("UPDATE teachers SET name='$name',sex='$sex',age='$age',dob='$dob',pob='$pob',phone='$phone',address='$address',image='$file_name' WHERE teacher_id=$id");
    ...
    ";
            ...
            echo "
    <script>
        alert('Error, can't update data');
         window.location.href = '../teacher/edit.php';
    </script>
    ";
        }
    }

    // $query = $conn->prepare("SELECT * FROM teachers where t_id=" . $_GET["id"]);
                         ...
                         <li class="nav-item">
                             ...
                             <div class="collapse" id="dashboard">
                                 <ul class="nav nav-collapse">
                                     ...
                                     <li>
                                         <a href="../teacher/teacher_attendance/attendance.php">
                                     ...
                                     <li>
                                         <a href="../teacher/teacher_account/account.php">
             ...
             <div class="container">
                 <div class="page-inner">
                     <div class="page-header">
                         <h3 class="fw-bold mb-3">Update Teachers</h3>
                     ...
                     <?php
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $query = $conn->query("SELECT * FROM teachers WHERE teacher_id=$id");
                        }
                        ...
                        ?>
                         ...
                         <div class="modal-body">
                             ...
                             <form action="edit.php " method="post" id="addForm">
                                 ...
                                 <div>
                                     <button type="submit" name="update" class="btn btn-primary" id="alert">Update</button>
                                     <button type="reset" class="btn btn-danger m-2" id="alert">Cancel</button>
