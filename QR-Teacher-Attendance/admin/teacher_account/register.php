    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="../teacher_account/register.php" method="post">
                    ...
                    <div class="text-center p-t-10">
                        ...
                        <a class="txt2" href="../teacher_account/login.php">
        ...
        if ($c_password != $password) {
            ...
            try {
                ...
                if (empty($nameExist)) {
                    ...
                    $insertStmt = $conn->prepare("INSERT INTO users (`name`, `username`, `password`) VALUES (:name, :username, :password)");
            ...
            ";
                    ...
                    echo "
            <script>
                alert('Erorr cannot register!');    
           window.location.href = '../teacher_account/register.php';
            </script>
            ";
                }
